...
Usage:
  summarize_cases.sh [options] AR CASES

AR file is as generated by process_multi_cases.sh
...
# Note that other rare sample types (Nbc, Tbm, Tpb) will not be counted.  These should be merged with N and T
    ...
    function count_entries {
        ...
        awk -v c=$CASE -v es=$ES -v st=$ST -v ref=$REF 'BEGIN{FS="\t";OFS="\t"}{if ( ($2 == c) && ($4 == es) && ($5 == st) && ($12 == ref)) print}' $AR | wc -l
    }
